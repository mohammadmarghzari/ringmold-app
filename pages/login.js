                              ...
                              <p style={{ color: "#9aa4b8" }}>برای ادامه با اکانت جیمیل وارد شو</p>
                                    ...
                                    <div className="card" style={{ textAlign: "right", marginTop: 30 }}>
                                      ...
                                      <p style={{ fontSize: 14, color: "#9aa4b8", marginTop: 8, lineHeight: 2 }}>
                                        سایز انگشتت و مشخصات طرح دلخواهت (شکل روکار، نگین، حکاکی، یا توضیح متنی کامل) رو وارد می‌کنی، یه مدل سه‌بعدی دقیق از قالب می‌سازه، فایل قابل چاپ سه‌بعدی (STL) و نقشه‌ی فنی PDF بهت می‌ده — همون چیزی که قالب‌ساز برای ساخت مدل مستر ریخته‌گری بهش نیاز داره. هزینه‌ی استفاده از ابزار طراحی بر اساس مدت زمان کارت از کیف پولت کسر می‌شه.
                                      </p>
                                    </div>
                                        </div>
                                          );
